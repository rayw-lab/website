...
export const problems = [
  ...
  },
  {
    ...
    teaser: '把个人 AI 技巧接进可量化、可追溯的团队流程。',
    how: '让 AI 成为团队流程的一部分：把需求、开发、测试和复盘串成清晰的协作链，在关键风险点保留人工判断，让效率能度量、结果能追溯，个人方法也能被团队复用。',
