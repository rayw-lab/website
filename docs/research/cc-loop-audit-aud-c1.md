...
- **W3' 排队实录**：21:31 nav-c1 抢窗（city-perf 短单）→ 21:40 nav-c1 续窗（playwright worker）→ 21:53 nav-c1 于新 worktree `nav-c1-main-wt` 再起 city-perf（疑似 main 树 PERF 对照单），R3 继续禁杀排队。
