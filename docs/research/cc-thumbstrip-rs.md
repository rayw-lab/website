...
| 触碰 | `e2e/cyber-city-minimap.spec.ts` | 追加 CITY-NAV-04（§5 断言集）；S8 触控断言按 §5-S8 路由口径**在 spec 内显式建 touch context**（默认路线，零 config 改动）；既有 01/02/03 期望零改 |
