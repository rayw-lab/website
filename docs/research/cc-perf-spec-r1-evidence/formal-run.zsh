...
RUN_LOG=/private/tmp/perf185-r1-full.log
SHELL_LOG=/private/tmp/perf185-r1-shell-state.log
MONITOR_LOG=/private/tmp/perf185-r1-host-monitor.log
STOP_FILE=/private/tmp/perf185-r1-monitor.stop
MONITOR=/private/tmp/perf185-r1-website-host-vacuum.py
