...
RUN_LOG=/private/tmp/perf185-r3-full.log
SHELL_LOG=/private/tmp/perf185-r3-shell-state.log
MONITOR_LOG=/private/tmp/perf185-r3-host-monitor.log
STOP_FILE=/private/tmp/perf185-r3-monitor.stop
MONITOR=/private/tmp/perf185-r3-website-host-vacuum.py
