...
| FV-W1 | W1 | 管线 + 门 + EP2/EP3 manifest | 执行方 | `scripts/`、`public/demo/frame-vault/`、`evidence/frame-vault/` | go | 两集过门 | PLANNED |
| FV-W2 | W2 | VolumeEngine + 刀锋 + 斜切 + 海报 | 执行方 | `halls/vault/` | W1 | 海报可下载、URL 确定性 | PLANNED |
