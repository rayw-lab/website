...
> 更新 2026-09-04 13:35 · 分支 `codex/nexus-hall-20260903` · worktree `~/studio-data-root/worktrees/website-nexus-hall` · base `codex/about-hall-20260902@f942a22` · 上次合流 — · 人测窗口 none
...
| NX-W7 | W7 | 城→厅转场（开车进楼动效/画面/跳转）+ 本楼 showcase 机位 | agy 调研 + 执行方实装 | `src/lab/world/areas/PoiArrival.ts`、`src/data/camera-shots.json`、`halls/nexus/*`、`HallChrome` 到达钩 | W5 | 城里按 E 进楼有前奏与转场，2×2（from=city 有/无） | **LIVE_OBSERVED**（R32：机位 11/11、城侧墨吞 + 楼侧墨幕落地并自看；本厅 e2e 25/25、城侧转场 spec 3/3、预算门绿，`b13f5ea`。residual：城侧墨吞中段慢放帧未进片） |
